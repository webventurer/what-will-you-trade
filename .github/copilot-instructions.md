...
### `/codefu`
**CRITICAL**: Read and follow EVERY step in `.claude/docs/check-me.md`

Please read .claude/docs/check-me.md first and follow all the AI assistant instructions in my documentation. Once you have read "check-me.md" respond: "I know codefu!" and continue following these instructions.

### `/commit` - Atomic Git Commit Workflow
**CRITICAL**: Read and follow EVERY step in `.claude/docs/git/atomic-git-commits.md`

This document contains the complete three-pass atomic commit methodology.

### `/create` - Creation Workflow
**CRITICAL**: Read and follow EVERY step in `.claude/docs/workflows/entry-points/create.workflow.md`

This workflow file contains the complete systematic process for creating any content.

### `/format` - Markdown Formatting Workflow
**CRITICAL**: Read and follow EVERY step in `.claude/docs/workflows/entry-points/format.workflow.md`

This workflow file contains the complete markdown formatting process with emphasis on hierarchy of attention.

### `/nextjs` - NextJS Development Workflow
**CRITICAL**: Read and follow EVERY step in `.claude/docs/workflows/entry-points/nextjs.workflow.md`
